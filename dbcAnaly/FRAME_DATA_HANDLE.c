...
FRAME_DATA_HANDLE(bms_0x458,Bms_0x458);
...
FRAME_DATA_HANDLE(bms_0x650,Bms_0x650);

FRAME_DATA_HANDLE(icm_0x6a0,Icm_0x6a0);

FRAME_DATA_HANDLE(icm_0x6a2,Icm_0x6a2);

FRAME_DATA_HANDLE(icm_0x6af,Icm_0x6af);

FRAME_DATA_HANDLE(chg_0x6d0,Chg_0x6d0);
...
FRAME_DATA_HANDLE(icm_0x420,Icm_0x420);

FRAME_DATA_HANDLE(gw_0x421,Gw_0x421);

FRAME_DATA_HANDLE(bcm_0x425,Bcm_0x425);

FRAME_DATA_HANDLE(peps_0x429,Peps_0x429);
...
FRAME_DATA_HANDLE(rms_0x6f2,Rms_0x6f2);
