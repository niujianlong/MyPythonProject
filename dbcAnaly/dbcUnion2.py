...
fw16=file("FRAME_DATA_HANDLE.c","w+")   #生成FRAME_DATA_HANDLE宏定义的函数调用
fw17=file("FRAME_MISSING_HANDLE.c","w+")   #生成FRAME_MISSING_HANDLE宏定义的函数调用
...
for line in open("ABUS_ICM.txt"):  
    ...
    if line_split[0]=='BO_': #如果以BO_开头则做下边的准备工作
        ...
        fw16.write("FRAME_DATA_HANDLE("+frameStructName.lower()+','+frameStructName.capitalize()+');\n\n') #具体数据的结构体
        fw17.write("FRAME_MISSING_HANDLE("+frameStructName.lower()+','+frameStructName.capitalize()+');\n\n') #具体数据的结构体
