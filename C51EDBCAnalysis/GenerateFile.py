...
CANProcessH = file(os.path.join(Base_Dir,'CAN','lib',"CANProcess.h"), "w+")
CANProcessC = file(os.path.join(Base_Dir,'CAN','src',"CANProcess.c"), "w+")
CANMissingProcessH = file(os.path.join(Base_Dir,'CAN','lib',"CANMissingProcess.h"), "w+")
CANMissingProcessC = file(os.path.join(Base_Dir,'CAN','src',"CANMissingProcess.c"), "w+")
...
def GenCANProcessH():
    ...
    CANProcessH.write('**************************************************************************/\n')
    for line in open(C51Edbc.struct_h_dir):
        CANProcessH.write(line)
    CANProcessH.write('\n/*************************************************************************\n')
    CANProcessH.write('**                  Is NO Frame Received                                **\n')
    CANProcessH.write('**************************************************************************/\n')
    for line in open(C51Edbc.CAN_IsNoMsgReceived_h_dir):
        CANProcessH.write(line)    
    CANProcessH.write('\n/*************************************************************************\n')
    CANProcessH.write('**                  Frame Signal Analysis Prototype                     **\n')
    CANProcessH.write('**************************************************************************/\n')
    for line in open(C51Edbc.SignalAnalysis_h_dir):
        CANProcessH.write(line) 
    CANProcessH.write('\n/*************************************************************************\n')
    CANProcessH.write('**                  Set Signal Function Prototype                       **\n')
    CANProcessH.write('**************************************************************************/\n')
    for line in open(C51Edbc.ICMSendFrameInterface_h_dir):
        CANProcessH.write(line)
...
def GenCANProcessC():    
    ...
    CANProcessC.write('**************************************************************************/\n')
    for line in open(C51Edbc.VariableDefinition_c_dir):
        CANProcessC.write(line)
    CANProcessC.write('\n\n/*************************************************************************\n')
    CANProcessC.write('**              CAN Missing Count Variable  Define                      **\n')
    CANProcessC.write('**************************************************************************/\n')
    for line in open(C51Edbc.missingCounter_c_dir):
        CANProcessC.write(line)
    CANProcessC.write('\n/*************************************************************************\n')
    CANProcessC.write('**              CAN Process Init                                        **\n')
    CANProcessC.write('**************************************************************************/\n\n')
    for line in open(C51Edbc.CANProcess_Init_c_dir):
        CANProcessC.write(line)
    CANProcessC.write('\n/*************************************************************************\n')
    CANProcessC.write('**              VBUS frame data handle                                  **\n')
    CANProcessC.write('**************************************************************************/\n\n')
    for line in open(C51Edbc.vbus_receive_frame_c_dir):
        CANProcessC.write(line)    
    CANProcessC.write('\n/*************************************************************************\n')
    CANProcessC.write('**              Frame Missing Handle                                    **\n')
    CANProcessC.write('**************************************************************************/\n\n')
    for line in open(C51Edbc.frameMissingProcess_c_dir):
        CANProcessC.write(line)      
    CANProcessC.write('\n/*************************************************************************\n')
    CANProcessC.write('**              Signal Analysis Task                                    **\n')
    CANProcessC.write('**************************************************************************/\n\n')
    for line in open(C51Edbc.SignalAnalysis_c_dir):
        CANProcessC.write(line)      
def GenCANMissingProcessH():        
    ...
    CANMissingProcessH.write('**************************************************************************/\n')    
    for line in open(C51Edbc.DefaultMissingProcess_h_dir):    
...
def GenCANMissingProcessC():        
    ...
    CANMissingProcessC.write('**************************************************************************/\n')
    for line in open(C51Edbc.CANServiceSetFunBody_c_dir):    
        CANMissingProcessC.write(line)
    CANMissingProcessC.write('/*************************************************************************\n')
    CANMissingProcessC.write('**              Set Frame Missing Default Value                         **\n')
    CANMissingProcessC.write('**************************************************************************/\n')    
    for line in open(C51Edbc.DefaultMissingProcess_c_dir):    
        CANMissingProcessC.write(line)
