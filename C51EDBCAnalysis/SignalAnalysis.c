void SignalAnalysisTask(){
  ...
  hum_gps.TIME_MODE_HUM = getuint8SigValue(hum_gps.data,1,2);
  hum_gps.MINUTES_HUM = getuint8SigValue(hum_gps.data,15,6);
  hum_gps.DAY_HUM = getuint8SigValue(hum_gps.data,17,5);
  hum_gps.WEEK_HUM = getuint8SigValue(hum_gps.data,20,3);
  hum_gps.YEAR_HUM = getuint8SigValue(hum_gps.data,24,5);
  hum_gps.MONTH_HUM = getuint8SigValue(hum_gps.data,28,4);
  hum_gps.SECOND_HUM = getuint8SigValue(hum_gps.data,7,6);
  hum_gps.HOUR_HUM = getuint8SigValue(hum_gps.data,9,5);
  ...
  icm_event_command_2.FOLLOW_ME_HOME_SETTING = getuint8SigValue(icm_event_command_2.data,2,3);
  icm_event_command_2.VSPEED_LOCKING = getuint8SigValue(icm_event_command_2.data,5,3);
  icm_event_command_2.CUTOFF_UNLOCK_4_DOORS = getuint8SigValue(icm_event_command_2.data,7,2);
  icm_event_command_2.LOCK_SUCCESS_SOUND = getuint8SigValue(icm_event_command_2.data,13,2);
  icm_event_command_2.DRL_OPEN = getuint8SigValue(icm_event_command_2.data,15,2);
  icm_general_status_3.INSTANT_FUEL_CONSUM = getuint16SigValue(icm_general_status_3.data,7,12);
  icm_general_status_3.AVERAGE_FUEL_CONSUM = getuint16SigValue(icm_general_status_3.data,11,12);
  icm_general_status_3.ENDURANCE_MILEAGE = getuint16SigValue(icm_general_status_3.data,31,12);
  icm_general_status_3.REMAIN_MAINTAIN_MILEAGE = getuint16SigValue(icm_general_status_3.data,47,16);
