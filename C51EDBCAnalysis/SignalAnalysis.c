void SignalAnalysisTask()
{
  ...
  pas_general_status.PAS_SYS_STATUS = getuint8SigValue(pas_general_status.data,1,2);
  pas_general_status.SVA_SYS_STATUS = getuint8SigValue(pas_general_status.data,3,2);
  pas_general_status.PA_FRONT_SYS_STATUS = getuint8SigValue(pas_general_status.data,5,2);
  pas_general_status.PA_REAR_SYS_STATUS = getuint8SigValue(pas_general_status.data,7,2);
  pas_general_status.PA_REARMIDLEFT_REG_OBJ_STATUS = getuint8SigValue(pas_general_status.data,11,4);
  pas_general_status.PA_REARLEFT_REG_OBJ_STATUS = getuint8SigValue(pas_general_status.data,15,4);
  pas_general_status.PA_FRONTLEFT_REG_OBJ_STATUS = getuint8SigValue(pas_general_status.data,19,4);
  pas_general_status.PA_REARRIGHT_REG_OBJ_STATUS = getuint8SigValue(pas_general_status.data,23,4);
  pas_general_status.PA_FRONTRIGHT_REG_OBJ_STATUS = getuint8SigValue(pas_general_status.data,27,4);
  pas_general_status.PA_FRONTMIDLEFT_REG_OBJ_STATUS = getuint8SigValue(pas_general_status.data,31,4);
  pas_general_status.REAR_MINI_PAS_DISTANCE = getuint8SigValue(pas_general_status.data,39,8);
  pas_general_status.FRONT_MINI_PAS_DISTANCE = getuint8SigValue(pas_general_status.data,47,8);
  pas_general_status.PA_REARMIDRIGHT_REG_OBJ_ST = getuint8SigValue(pas_general_status.data,51,4);
  pas_general_status.SVA_WARNING_STATUS_RIGHT = getuint8SigValue(pas_general_status.data,53,2);
  pas_general_status.SVA_WARNING_STATUS_LEFT = getuint8SigValue(pas_general_status.data,55,2);
  pas_general_status.NEAREST_REAR_PAS = getuint8SigValue(pas_general_status.data,57,2);
  pas_general_status.PA_PAS_SW_STATUS = getuint8SigValue(pas_general_status.data,59,2);
  pas_general_status.PA_FRONTMIDRIGHT_REG_OBJ_ST = getuint8SigValue(pas_general_status.data,63,4);
  ...
  icm_general_status.DATA_VALID = getuint8SigValue(icm_general_status.data,0,1);
  icm_general_status.AIRBAG_WARNINGLAMP_STATUS = getuint8SigValue(icm_general_status.data,1,1);
  icm_general_status.NIGHT_PANEL = getuint8SigValue(icm_general_status.data,2,1);
  icm_general_status.DATA_VALID_RHEOSTAT = getuint8SigValue(icm_general_status.data,4,2);
  icm_general_status.WASHER_FLUID_LEVEL_LOW = getuint8SigValue(icm_general_status.data,5,1);
  icm_general_status.ODOMETER_RESET_COUNTER_ICM = getuint8SigValue(icm_general_status.data,7,2);
  icm_general_status.RHEOSTAT_LEVEL = getuint8SigValue(icm_general_status.data,15,8);
  icm_general_status.DISPLAYED_TOTAL_DISTANCE = getuint32SigValue(icm_general_status.data,23,32);
  icm_general_status.BATTERY_VOLTAGE_LEVEL = getuint8SigValue(icm_general_status.data,55,8);
  icm_general_status.ODOMETER_OFFSET_ICM = getuint8SigValue(icm_general_status.data,63,8);
  icm_general_status_2.HAND_BRAKE_ICM = getuint8SigValue(icm_general_status_2.data,0,1);
  icm_general_status_2.REMOTE_START_RESPONSE_ICM = getuint8SigValue(icm_general_status_2.data,7,1);
  icm_general_status_2.FUELTANK_REMAINING = getuint8SigValue(icm_general_status_2.data,15,8);
  icm_general_status_2.OILPUMP_RESISTER_ICM = getuint16SigValue(icm_general_status_2.data,19,12);
  ...
  icm_general_status_3.INSTANT_FUEL_CONSUM = getuint16SigValue(icm_general_status_3.data,7,12);
  icm_general_status_3.AVERAGE_FUEL_CONSUM1 = getuint16SigValue(icm_general_status_3.data,11,12);
  icm_general_status_3.ENDURANCE_MILEAGE = getuint16SigValue(icm_general_status_3.data,31,12);
  icm_general_status_3.REMAIN_MAINTAIN_MILEAGE = getuint16SigValue(icm_general_status_3.data,35,16);
  icm_general_status_3.AVERAGE_FUEL_CONSUM2 = getuint16SigValue(icm_general_status_3.data,51,12);
