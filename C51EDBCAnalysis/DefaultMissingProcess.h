...
EXTERN void Sethum_event_command_2MissingDefaultValue(void);
EXTERN void Setnavi_informationMissingDefaultValue(void);
EXTERN void Setmedia_informationMissingDefaultValue(void);
