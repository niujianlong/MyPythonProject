...
void set_VCU_611_OBC_ERR_IND( uint8 VCU_611_OBC_ERR_IND)
{
...
void set_VCU_611_OBC_REMIND_LAMP( uint8 VCU_611_OBC_REMIND_LAMP)
{
...
void set_VCU_617_OBC_SOON( uint8 VCU_617_OBC_SOON)
{
     setuint8SigValue(vcu_0x617.data,0,6,1,VCU_617_OBC_SOON);
}

void set_VCU_617_VEH_SPD( uint16 VCU_617_VEH_SPD)
{
...
void set_TBOX_6F2_YEAR_TIME( uint8 TBOX_6F2_YEAR_TIME)
{
     setuint8SigValue(tbox_0x6f2.data,0,0,8,TBOX_6F2_YEAR_TIME);
}

void set_TBOX_6F2_MONTH_TIME( uint8 TBOX_6F2_MONTH_TIME)
{
     setuint8SigValue(tbox_0x6f2.data,1,12,4,TBOX_6F2_MONTH_TIME);
}

void set_TBOX_6F2_DAY_TIME( uint8 TBOX_6F2_DAY_TIME)
{
     setuint8SigValue(tbox_0x6f2.data,2,16,5,TBOX_6F2_DAY_TIME);
}

void set_TBOX_6F2_HOUR_TIME( uint8 TBOX_6F2_HOUR_TIME)
{
     setuint8SigValue(tbox_0x6f2.data,3,27,5,TBOX_6F2_HOUR_TIME);
}

void set_TBOX_6F2_MINUTE_TIME( uint8 TBOX_6F2_MINUTE_TIME)
{
     setuint8SigValue(tbox_0x6f2.data,4,32,6,TBOX_6F2_MINUTE_TIME);
}

/*************************************************************************
**              Set Frame Missing Default Value                         **
**************************************************************************/

void Setvcu_0x212MissingDefaultValue(void)
{
 set_VCU_212_SHIFT_POSITON(0);
 set_VCU_212_SHIFT_ERROR_OP(0);
}

void Setvcu_0x214MissingDefaultValue(void)
{
 set_VCU_214_VEH_STATE(0);
}

void Setmcu_0x230MissingDefaultValue(void)
{
 set_MCU_230_SYS_FAULT_LAMP(0);
 set_MCU_230_BRAKE_ENGERY_RECOV_STA(0);
 set_MCU_230_MOT_FAULT_LAMP(0);
 set_MCU_230_FAULT_ALARM(0);
 set_MCU_230_LIMP_LAMP(0);
 set_MCU_230_MOT_TEMP_H_IND(0);
 set_MCU_230_MOT_FAULT_IND(0);
 set_MCU_230_MOT_SYS_TEMP_HIGH_LAMP(0);
 set_MCU_230_MCU_PWR_PENT(0);
}

void Setabs_0x318MissingDefaultValue(void)
{
 set_ABS_318_ABSActive(0);
 set_ABS_318_ABSFail(0);
 set_ABS_318_EBDFail(0);
}

void Setmcu_0x430MissingDefaultValue(void)
{
 set_MCU_430_MOT_SPD(0);
}

void Setbms_0x450MissingDefaultValue(void)
{
 set_BMS_450_BATT_SOC(0);
}

void Setbms_0x451MissingDefaultValue(void)
{
 set_BMS_451_BATT_CUR(0);
 set_BMS_451_BATT_VOLT_V2(0);
}

void Seteps_0x470MissingDefaultValue(void)
{
 set_EPS_470_EPS_STA(0);
}

void Setepb_0x4c8MissingDefaultValue(void)
{
 set_EPB_4C8_EPB_ParkLampState(0);
 set_EPB_4C8_EPB_WarningLampState(0);
}

void Setecc_0x4e0MissingDefaultValue(void)
{
 set_ECC_4E0_OUT_TEMP(0);
}

void Setehu_0x585MissingDefaultValue(void)
{
 set_EHU_585_EHU_Theme(0);
 set_EHU_585_EHU_State(0);
}

void Setvcu_0x611MissingDefaultValue(void)
{
 set_VCU_611_READY_LAMP(0);
 set_VCU_611_BATT_PWRON(0);
 set_VCU_611_OBC_ERR_IND(0);
 set_VCU_611_FAULT_ALARM(0);
 set_VCU_611_CHARG_CONNECT_LAMP(0);
 set_VCU_611_Batt_FAULT_IND(0);
 set_VCU_611_LIMP_LAMP(0);
 set_VCU_611_VEH_INSULATION_FAULT_IND(0);
 set_VCU_611_BATT_FAULT_IND(0);
 set_VCU_611_BRAKE_FAULT_IND(0);
 set_VCU_611_N_START_REQ(0);
 set_VCU_611_BATT_FAULT_LAMP(0);
 set_VCU_611_OBC_REMIND_LAMP(0);
}

void Setvcu_0x615MissingDefaultValue(void)
{
 set_VCU_615_ENERGY_CONSUM_AV(0);
}

void Setvcu_0x616MissingDefaultValue(void)
{
 set_VCU_616_DRIVE_RANGE(0);
}

void Setvcu_0x617MissingDefaultValue(void)
{
 set_VCU_617_SYS_FAULT_LAMP(0);
 set_VCU_617_BRAKE_ENGERY_RECOV_LEVEL(0);
 set_VCU_617_OBC_SOON(0);
 set_VCU_617_VEH_SPD(0);
 set_VCU_617_ENERGY_CONSUM_IN(0);
}

void Setvcu_0x61dMissingDefaultValue(void)
{
 set_VCU_61D_CHG_STATE(0);
 set_VCU_61D_BATT_HEAT_STA(0);
}

void Setpdc_0x1b0MissingDefaultValue(void)
{
 set_PDC_1B0_SYSTEM_STATUS(0);
 set_PDC_1B0_SYSTEM_ALARM_LEVEL(0);
 set_PDC_1B0_MRL_OBSTACLE_DIS(0);
 set_PDC_1B0_RL_OBSTACLE_DIS(0);
 set_PDC_1B0_RR_OBSTACLE_DIS(0);
 set_PDC_1B0_OBSTACLE_DIS_MIN(0);
}

void Setvbus_vcu_0x214MissingDefaultValue(void)
{
 setvbus_VCU_214_VEH_STATE(0);
}

void Setvbus_mcu_0x230MissingDefaultValue(void)
{
 setvbus_MCU_230_ASR_OFF_LAMP(0);
 setvbus_MCU_230_ASR_EN_LAMP(0);
}

void Settpms_0x2a0MissingDefaultValue(void)
{
 set_TPMS_2A0_TIRE_POSITION(0);
 set_TPMS_2A0_SIGNAL_TIRE_STATUS(0);
 set_TPMS_2A0_SYSTEM_STATUS(0);
 set_TPMS_2A0_SIGNAL_TIRE_LEAK_STATUS(0);
 set_TPMS_2A0_SIGNAL_TIRE_PRESSURE_STATUS(0);
 set_TPMS_2A0_SIGNAL_TIRE_TEMPERATURE(0);
 set_TPMS_2A0_SIGNAL_SENSOR_SOC_STATUS(0);
 set_TPMS_2A0_SIGNAL_TIRE_PRESSURE(0);
 set_TPMS_2A0_SIGNAL_TIRE_TEMPERATURE_VEL(0);
 set_TPMS_2A0_SIGNAL_SENSOR_SOC(0);
 set_TPMS_2A0_ALARM_STATUS(0);
}

void Setpeps_0x479MissingDefaultValue(void)
{
 set_PEPS_479_POWER_MODE(0);
 set_PEPS_479_RM_Key_LowBattery_Alert(0);
 set_PEPS_479_AuthFailWarning(0);
 set_PEPS_479_One_KeyStart_Swith_Error(0);
 set_PEPS_479_Press_Brake_Pedal_Alert(0);
 set_PEPS_479_ESCLWarning(0);
 set_PEPS_479_ETWS_Alert(0);
 set_PEPS_479_CID_Left_Alert(0);
 set_PEPS_479_DOOR_Lock_Ig_NotOff_Alert(0);
 set_PEPS_479_DOOR_Open_Lock_Alert(0);
 set_PEPS_479_Key_Insid_Vehicle_Alert(0);
}

void Setbcm_0x4a0MissingDefaultValue(void)
{
 set_BCM_4A0_HIGH_BEAM_LIGHT_CMD(0);
 set_BCM_4A0_LOW_BEAM_LIGHT_CMD(0);
 set_BCM_4A0_FRONT_POSITION_LAMP_CMD(0);
 set_BCM_4A0_FRONT_FOG_LAMP_CMD(0);
 set_BCM_4A0_REAR_FOG_LAMP_CMD(0);
 set_BCM_4A0_LEFT_TRUN_LIGHT_CMD(0);
 set_BCM_4A0_RIGHT_TRUN_LIGHT_CMD(0);
 set_BCM_4A0_EXTERIOR_LAMP_SWITCH(0);
}

void Setuec_0x4c9MissingDefaultValue(void)
{
 set_UEC_4C9_Hs_HLBeam_Lamp_Left_Err(0);
 set_UEC_4C9_Hs_HLBeam_Light_Left_Err(0);
 set_UEC_4C9_Hs_HLBeam_Lamp_Right_Err(0);
 set_UEC_4C9_Hs_HLBeam_Light_Right_Err(0);
 set_UEC_4C9_Hs_HLBeam_FDSF_Err(0);
 set_UEC_4C9_Hs_Position_Lamp_Err(0);
 set_UEC_4C9_Hs_Daytime_Light_Left_Err(0);
 set_UEC_4C9_Hs_Daytime_Light_Right_Err(0);
 set_UEC_4C9_Hs_FrontFog_Light_Left_Err(0);
 set_UEC_4C9_Hs_FrontFog_Light_Right_Err(0);
 set_UEC_4C9_Hs_LR_Brake_Light_Err(0);
 set_UEC_4C9_Hs_High_Brake_Light_Err(0);
}

void Setpeps_0x570MissingDefaultValue(void)
{
 set_PEPS_570_Door_Lock_Cmd(0);
}

void Seticm_0x620MissingDefaultValue(void)
{
 set_ICM_620_DATA_VALID_ODO(0);
 set_ICM_620_ODOMETER_RESET_COUNTER(0);
 set_ICM_620_DISPLAYED_TOTAL_DISTANCE(0);
 set_ICM_620_ODOMETER_OFFSET(0);
}

void Setbcm_0x660MissingDefaultValue(void)
{
 set_BCM_660_FD_DOOR_STS(0);
 set_BCM_660_FP_DOOR_STS(0);
 set_BCM_660_FOLLOW_ME_HOME_STS(0);
 set_BCM_660_TRUNK_STA(0);
}

void Setbcm_0x661MissingDefaultValue(void)
{
 set_BCM_661_EB_ODO_VALID(0);
 set_BCM_661_ODOMETER_RESET_COUNTER(0);
 set_BCM_661_EB_ODO_DISTANCE(0);
 set_BCM_661_ODOMETER_OFFSET(0);
}

void Seticm_0x6a0MissingDefaultValue(void)
{
 set_ICM_6A0_ODO(0);
}

void Seticm_0x6a2MissingDefaultValue(void)
{
 set_ICM_6A2_IP_Fault(0);
 set_ICM_6A2_IP_Theme(0);
 set_ICM_6A2_Distance_To_Service(0);
 set_ICM_6A2_Day_To_Service(0);
}

void Seticm_0x6afMissingDefaultValue(void)
{
 set_ICM_6AF_CAL_VERS(0);
 set_ICM_6AF_PART_VERS(0);
 set_ICM_6AF_HW_VERS(0);
 set_ICM_6AF_SW_VERS(0);
}

void Settbox_0x6f2MissingDefaultValue(void)
{
 set_TBOX_6F2_YEAR_TIME(0);
 set_TBOX_6F2_MONTH_TIME(0);
 set_TBOX_6F2_DAY_TIME(0);
 set_TBOX_6F2_HOUR_TIME(0);
 set_TBOX_6F2_MINUTE_TIME(0);
}
