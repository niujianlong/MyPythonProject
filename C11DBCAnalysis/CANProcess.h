...
/*************************************************************************
**                  Is NO Frame Received                                **
**************************************************************************/
#define ISNOMSGRECEIVED()\
(  (GET_VCU_0X212_MISSING_FLAG()==1)\
 &&(GET_VCU_0X214_MISSING_FLAG()==1)\
 &&(GET_MCU_0X230_MISSING_FLAG()==1)\
 &&(GET_ABS_0X318_MISSING_FLAG()==1)\
 &&(GET_MCU_0X430_MISSING_FLAG()==1)\
 &&(GET_BMS_0X450_MISSING_FLAG()==1)\
 &&(GET_BMS_0X451_MISSING_FLAG()==1)\
 &&(GET_EPS_0X470_MISSING_FLAG()==1)\
 &&(GET_EPB_0X4C8_MISSING_FLAG()==1)\
 &&(GET_ECC_0X4E0_MISSING_FLAG()==1)\
 &&(GET_EHU_0X585_MISSING_FLAG()==1)\
 &&(GET_VCU_0X611_MISSING_FLAG()==1)\
 &&(GET_VCU_0X615_MISSING_FLAG()==1)\
 &&(GET_VCU_0X616_MISSING_FLAG()==1)\
 &&(GET_VCU_0X617_MISSING_FLAG()==1)\
 &&(GET_VCU_0X61D_MISSING_FLAG()==1)\
 &&(GET_PDC_0X1B0_MISSING_FLAG()==1)\
 &&(GET_VBUS_VCU_0X214_MISSING_FLAG()==1)\
 &&(GET_VBUS_MCU_0X230_MISSING_FLAG()==1)\
 &&(GET_TPMS_0X2A0_MISSING_FLAG()==1)\
 &&(GET_PEPS_0X479_MISSING_FLAG()==1)\
 &&(GET_BCM_0X4A0_MISSING_FLAG()==1)\
 &&(GET_UEC_0X4C9_MISSING_FLAG()==1)\
 &&(GET_PEPS_0X570_MISSING_FLAG()==1)\
 &&(GET_BCM_0X660_MISSING_FLAG()==1)\
 &&(GET_BCM_0X661_MISSING_FLAG()==1)\
 &&(GET_TBOX_0X6F2_MISSING_FLAG()==1)\
)\
