...
# 路径定义
struct_h_dir = ur'.\..\gen\struct.h'
CAN_IsNoMsgReceived_h_dir = ur'.\..\gen\CAN_IsNoMsgReceived.h'
VariableDefinition_c_dir = ur'.\..\gen\VariableDefinition.c'
missingCounter_c_dir = ur'.\..\gen\missingCounter.c'
SignalAnalysis_c_dir = ur'.\..\gen\SignalAnalysis.c'
SignalAnalysis_h_dir = ur'.\..\gen\SignalAnalysis.h'
CANServiceSetFunBody_c_dir = ur'.\..\gen\CANServiceSetFunBody.c'
CANProcess_Init_c_dir = ur'.\..\gen\CANProcess_Init.c'
DefaultMissingProcess_c_dir = ur'.\..\gen\DefaultMissingProcess.c'
DefaultMissingProcess_h_dir = ur'.\..\gen\DefaultMissingProcess.h'
vbus_receive_frame_c_dir = ur'.\..\gen\vbus_receive_frame.c'
frameMissingProcess_c_dir = ur'.\..\gen\frameMissingProcess.c'
frameMissingProcessEnum_h_dir = ur'.\..\gen\frameMissingProcessEnum.h'
ICMSendFrameInterface_h_dir = ur'.\..\gen\ICMSendFrameInterface.h'
...
sendFrameStructName = ['icm_acc_request', 'icm_event_command', 'icm_general_status', 'icm_general_status_2', 'icm_general_status_3', 'icm_general_test_1', 'icm_general_test_2', 'icm_general_test_3', 'icm_general_test_4', 'icm_general_test_5']
...
def TheMainFunction():
    ...
    for line in open(ur'.\..\gen\C53FSorted.txt'):  
        line_split = line.split(' ')
        # print line_split
        if line_split[0] == 'BO_':
            frameID = int(line_split[1])
            frameStructName = line_split[2][:-1]  # [:-1]的目的是去掉末尾的：号
            if hex(frameID) == '0x318' or hex(frameID) == '0x370':  # 只有硬实时的报文才需要填在这里，如果是软实时的，不需要填在这里
