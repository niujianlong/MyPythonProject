        ...
        for port_num in PortGroup:
            if index == 1:
                if port_num == 0: 
                    ...
                    fdio_h_w.write('{ JPORT' + str(port_num - 46) + ' ,    (uint16*)(&JP' + str(port_num - 46) + ') ,    (uint16*)(&JPPR' + str(port_num - 46) + ') }, \\\n')
                else:
                    fdio_h_w.write('{ PORT' + str(port_num) + ' ,    (uint16*)(&P' + str(port_num) + ') ,    (uint16*)(&PPR' + str(port_num) + ') }, \\\n') 
            for reg_name in registers:
                if port_num == 46:
                    fpor_w.write('{ (uint16 *) &J' + reg_name + str(port_num - 46) + ' ,    (uint16)(J' + reg_name + str(port_num - 46) + '_' + fun_list[index] + ') }, \\\n')    
                else:
                    if port_num == 0:
