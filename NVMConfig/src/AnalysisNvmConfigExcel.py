...
def GenExcelCommonAnnotation(worksheet, filename, style):
    ...
    worksheet.write(13, 5, '**          Warning :This file generated by tool don\'t modify it manually.\n', style)
...
def WriteNVMMapTable():
    ...
    AnnotationStyle = xlwt.easyxf('pattern: pattern solid, fore_colour bright_green; font: bold on;')
